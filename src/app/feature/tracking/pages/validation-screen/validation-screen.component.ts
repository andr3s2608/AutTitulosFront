  ...
  private loadInfoTramiteActual(): void {
    this.validationForm = this.fb.group({
      ...
      basicDataForm:this.fb.group({
        ...
        primerNombre: [ this.tramiteActual.user.primerNombre , [ Validators.required ]],
        segundoNombre: [ this.tramiteActual.user.segundoNombre ],
        primerApellido: [ this.tramiteActual.user.primerApellido , [ Validators.required ]],
        segundoApellido: [ this.tramiteActual.user.segundoApellido ],
        email: [ this.tramiteActual.user.email , [ Validators.required, Validators.email ]],
        ...
        telefonoFijo: [ this.tramiteActual.user.telefonoFijo , [ Validators.minLength(7), Validators.maxLength(10), Validators.pattern("^[0-9]*$") ]],
        telefonoCelular: [ this.tramiteActual.user.telefonoCelular , [ Validators.required, Validators.minLength(10), Validators.maxLength(10), Validators.pattern("^[0-9]*$") ]],
