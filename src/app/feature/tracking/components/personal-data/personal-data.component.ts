...
export class PersonalDataComponent extends AppBaseComponent implements OnInit{
  ...
  public getErrorMessage(field: string): string {
    let message;
    const required: Array<string> = ['primerNombre', 'primerApellido', 'tipoDocumento', 'numeroIdentificacion', 'telefonoCelular', 'email', 'confirmarEmail', 'fechaNacimiento', 'sexo', 'genero', 'orientacionSexual', 'etnia', 'estadoCivil', 'nivelEducativo'];
    ...
    if (this.isTouchedField(this.basicDataForm, field)) {
      ...
      else if (dateError.includes(field) && this.basicDataForm?.get(field).hasError('invalidDate') ) {
